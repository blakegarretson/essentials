...
- [Affinity Suite](https://affinity.serif.com/en-us/) (Photos, Designer, and Publisher): While I love Gimp and Inkscape, Affinity is worth the reasonably priced one-time purchase. The functionality isn’t always much better than the free options (although it often is), but the interface and user experience is really well thought out and polished. For most people, Affinity is probably even a better (and cheaper!) alternative to the Adobe suite. **(Windows, Mac)**
