...
- [Zettlr](https://zettlr.com) advertises itself as a “one-stop publication workbench”, and that’s an apt description. While excellent for notes, it handles long projects without breaking a sweat, especially if you need to handle citations, LaTeX math equations, or diagrams. Like Obsidian, it has a very nice live-preview which I find mandatory for a modern writing app. Unlike Obsidian, it does not support plugins, but tools like LanguageTool are builtin, and I like the simplicity.
