...
- [Spatterlight](https://github.com/angstsmurf/spatterlight) is the best all around choice for Mac in my opinion. It supports many interpreters with only a couple exceptions, has autosave and other quality of life features, and has fairly extensive customization. Tip: the Homebrew version is often newer than the App Store version. **(Mac)**
