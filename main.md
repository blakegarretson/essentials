...
- [JASP](https://jasp-stats.org/) and/or [Jamovi](https://www.jamovi.org/): The reason I list both JASP and Jamovi here is because they have different strengths and statistical capabilities, so depending on your data and what type of analysis you need, one may be a better choice for you. They are in tight competition and both have seen active development over the years, so my top choice between the two has changed a few times. If you don’t know what you need, I would start with JASP. They are both are great packages for quickly analyzing some data and making decent-looking stats plots with very little effort. If I want simple descriptive statistics, a histogram, or a quick t-test, either of them make it easy (although honestly, if I need much more than that I’m probably in Jupyter using Python with libraries like Pandas to help slice and dice the data.) While they look very polished, and the core functionality is there, I wish there were more customization options for the graphs and more data manipulation tools. Also, it’s worth noting that both are front-ends for R, the 800-pound-gorilla of stats packages, so there are a number of modules available to add functionality. 
