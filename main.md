...
- [Surge XT](https://surge-synthesizer.github.io) is a hybrid synthesizer with more features than I can list here. The presets are comprehensive and you can make basically any sound you can imagine with it. It’s like jumbling all the synths from the 80s into one. [✽](#copy:brew install --cask surge-xt)
- [dexed](https://asb2m10.github.io/dexed/) is a faithful recreation of the Yamaha DX7 synth. [✽](#copy:brew install --cask dexed)
