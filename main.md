...
- *The above options can honestly be a bit overwhelming if you just want to edit a simple Markdown file. Also worth considering:*
    ...
    - [MarkEdit](https://github.com/MarkEdit-app/MarkEdit) reminds me more of a code editor that supports Markdown than a modern writing app, but it is excellent at being a “Markdown code editor”. Besides syntax highlighting, it  has keyboard shortcuts and toolbar commands to handle all your Markdown formatting needs. There is no in-app rendering, but it has builtin *pandoc* support to generate various formats, including PDF, HTML, and EPUB. **(Mac)**
